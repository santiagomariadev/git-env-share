...
- `ges init` creates a repo config when missing.
...
Use this path when the repository is configured with `mode: "age"`.
...
Use this path when the repository is configured with `mode: "ssh"`.
